...
class CommandBufferQueue final {
    ...
    public:        
        ...
        void startQueue(std::function<VkCommandBuffer(uint16_t, const bool)> commandBufferCreation, 
                        std::function<void(VkCommandBuffer)> commandBufferDeletion, uint16_t numberOfFrames, const bool useSecondaryBuffers = false) {
